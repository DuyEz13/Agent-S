...
def run_agent(agent, instruction: str, scaled_width: int, scaled_height: int):
    ...
    for step in range(100):
        ...
        print(f"\n🔄 Step {step + 1}/100: Getting next action from agent...")
        ...
        if "done" in code[0].lower() or "fail" in code[0].lower():
            ...
            edt = time.time()
            elapsed = edt - stt
            print(f"Step {step + 1}: {elapsed:.2f} seconds")
...
def main():
    ...
    #     "--model_api_key",
    #     type=str,
    #     default="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",
    ...
    parser.add_argument(
        "--model_api_key",
        type=str,
        default="AIzaSyDJc_dxJAjykN_2cDYpQywuREkA28qSXWs",
        help="The API key of the main generation model.",
    )
    parser.add_argument(
        "--model_temperature",
    ...
    parser.add_argument(
        "--ground_api_key",
        type=str,
        default="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",
